...
# How to use
Add this maven repo url to your project's buildscript repositories **https://mymavenrepo.com/repo/QdmWCKUvofW6L7vIcGYp/** and add injector lib to you classpath **com.artyomd.injector:injector:0.2.1** . Your buildscript should look like this.
```
buildscript {
    ...
    dependencies {
        ...
        classpath 'com.artyomd.injector:injector:0.2.1'
    }
}
```
...
```
	implementation "com.artyomd.injector:injector-android:0.2.1@aar"
```
